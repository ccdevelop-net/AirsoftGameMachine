...
//---------------------------------------------------------------------
float Location::DistanceRadians(const Location & p1, const Location & p2) {
...
//---------------------------------------------------------------------
float Location::EquirectDistanceRadians(const Location & p1, const Location & p2) {
...
float Location::BearingTo(const Location & p1, const Location & p2) {
  int32_t dLonL   = SafeDLon(p2.Lon(), p1.Lon());
  float   dLon    = dLonL * RAD_PER_DEG * LOC_SCALE;
  int32_t dLatL   = p2.Lat() - p1.Lat();
...
//---------------------------------------------------------------------
void Location::OffsetBy(float distR, float bearingR ) {
